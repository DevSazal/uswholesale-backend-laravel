                    ...
                    <form method="POST" class="form" action="{{route('supplier.add')}}"  id="signup">
                      ...
                      <div class="signup-content">
                          <div class="row">
                              <div class="col-md-6">
                                  <div class="form__group">
                                      <input name="username" type="text" id="usernameReg" class="form__input" placeholder="Your Username" required>
                                  ...
                                  <div class="form__group">
                                      <input name="password" type="password" id="passwordReg" class="form__input" placeholder="Password" required>
                                      <label for="password" class="form__label">Password</label>
                                  </div>
                                  <div class="form__group">
                              ...
                              <div class="col-md-6">
                                  ...
                                  <div class="form__group">
                                      <input name="address" type="text" id="address" class="form__input" placeholder="Address">
